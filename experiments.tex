...
{\bf In addition to these, we also present results on selected medium and large Pajek data sets \cite{pajek2006}, and a representative sample of graphs from the Stanford Large Network Dataset Collection \cite{stanford_dataset}. These are available in Table \ref{tab:pajek_stanford} in the Appendix.}
