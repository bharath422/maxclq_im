...
University of Florida Sparse Matrix Collection  \cite{Davis97theuniversity}, {\bf 5 medium to large graphs from Pajek data sets \cite{pajek2006}, and a 10 graphs from the Stanford Large Network Dataset Collection \cite{stanford_dataset}.}
