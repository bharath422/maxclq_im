...
$^{\rm \dag}$Washington State University, Pullman, WA 99163.
...
\bibitem{corman2002}
S.~R. Corman, T.~Kuhn, R.~D. Mcphee, and K.~J. Dooley.
\newblock {\em : {Studying} complex discursive systems: {Centering} resonance
  analysis of communication}.
\newblock Human Communication Research 28(2), 157Ð206, 2002.
...
\newblock In {\em Experimental Algorithms}, volume 6630 of {\em Lecture Notes in Computer Science}, pages 364--375. Springer Berlin Heidelberg, 2011.
%P. M. Pardalos and S. Rebennack, editors, 
...
\newblock : {The} {NBER} patent citation data file: {Lessons}, insights and
  methodological tools.
\newblock {\em Tech. rep. (2001), {NBER} {Working} {Paper}}, 8498, 2001.
...
\bibitem{foldoc}
D. Howe, \emph{Foldoc: Free on-line dictionary of computing},
  \urlprefix\url{http://foldoc.org/}.
...
\bibitem{hep-th-kdd}
\emph{Kdd cup (2003)},
  \urlprefix\url{http://www.cs.cornell.edu/projects/kddcup/index.html}.

\bibitem{eatRS}
G.~R.~Kiss, C.~Armstrong, R.~Milroy, and L.~Piper. 
\newblock An associative thesaurus of English and its computer analysis. In A.J. Aitken., R.W. Bailey, and N. Hamilton-Smith. (Eds.)
\newblock {\em The Computer and Literary Studies}, Edinburgh: University Press, 1973.
...
\bibitem{stanford_dataset}
J. Leskovec, \emph{Stanford large network dataset collection},
  \urlprefix\url{http://snap.stanford.edu/data/index.html}.

\bibitem{web-google}
\emph{Google programming contest (2002)},
  \urlprefix\url{http://www.google.com/programming-contest/}.

\bibitem{leskovec2007}
J.~Leskovec, L.~Adamic, and B.~Adamic.
\newblock {\em {The} dynamics of viral marketing}.
\newblock ACM Transactions on the Web 1(1), 2007.

\bibitem{leskovec2010}
J.~Leskovec, D.~Huttenlocher, and J.~Kleinberg.
\newblock {\em {Predicting} positive and negative links in online social networks}.
\newblock In Proc 19th Int. Conf. on World Wide Web., pp. 641Ð650. WWW Õ10, ACM 2010.

\bibitem{leskovec2007-2}
J.~Leskovec, J.~Kleinberg, and C.~Faloutsos.
\newblock {\em {Graph} evolution: {Densification} and shrinking diameters}.
\newblock ACM Transactions on Knowledge Discovery from Data 1(1), 2007.
...
\bibitem{a6040618}
C. McCreesh and P. Prosser.
\newblock Multi-threading a state-of-the-art maximum clique algorithm.
\newblock {\em Algorithms}, 6(4):618--635, 2013.
...
\bibitem{richardson2003}
M.~Richardson, R.~Agrawal, and P.~Domingos.
\newblock {\em {Trust} management for the semantic web}.
\newblock In {ISWC}, 2003.
