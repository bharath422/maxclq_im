...
algorithms by Carraghan and Pardalos \cite{pardalos}, \"{O}sterg\.{a}rd \cite{ostergard}, {\bf Tomita et al. \cite{citeulike:7905505}\cite{walcom}, Konc and Jane\v{z}i\v{c} \cite{konc2007improved}, and Segundo et al.~\cite{SanSegundo}}. 
