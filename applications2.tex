...
\subsection{The Clique Percolation Method}
...
A large clique of size $q >k $ contains $\binom{q}{k}$ different {\em k-cliques}.
...
We devised an algorithm based on a similar idea as the CPM,
...
We tested our algorithm on the LFR benchmarks\footnote{http://sites.google.com/site/andrealancichinetti/files} proposed in \cite{2008PhRvE..78d6110L}. These benchmarks allow
...
Table $\ref{tab:applications1}$ shows the time taken by CFinder and our method 
