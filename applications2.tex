...
{\bf Our Method. } We devised an algorithm based on a similar idea as the CPM,
...
The results of the algorithms for $k$=4 on all the five real-world graphs is shown in 
